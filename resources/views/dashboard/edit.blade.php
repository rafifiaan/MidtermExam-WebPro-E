...
<div class="container pt-2">
    ...
    <div class="card border-0 shadow rounded">
        <div class="card-body">
            <h1>Edit Kos</h1>
            <form action="/dashboard/{{ $kos->id }}" method="post">
                @method('put')
                @csrf
                <!-- Name input -->
                ...
                <div class="form-group mb-1">
                    ...
                    required value="{{ old('slug', $kos->slug) }}" />
                ...
                <div class="form-group mb-1">
                    ...
                    required>{{ old('description', $kos->description) }}</textarea>
                ...
                <div class="form-group mb-1">
                    ...
                    required value="{{ old('price', $kos->price) }}" />
                ...
                <div class="form-group mb-1">
                    ...
                    required value="{{ old('phone', $kos->phone) }}" />
                ...
                <div class="form-group mb-1">
                    ...
                    required value="{{ old('image', $kos->image) }}" />
                ...
                <div class="form-group mb-1">
                    ...
                    required value="{{ old('address', $kos->address) }}" />
                ...
                <div class="form-group mb-1">
                    ...
                    required value="{{ old('maps', $kos->maps) }}" />
