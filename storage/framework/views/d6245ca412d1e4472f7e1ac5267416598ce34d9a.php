    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-md-6 row-content">
                ...
                <a class="btn rounded-pill btn-rounded text-white" style="background-color:#345cb3;"href="<?php if(auth()->guard()->check()): ?> <?php echo e(route('catalog')); ?> <?php endif; ?> <?php if(auth()->guard()->guest()): ?> <?php echo e(route('login')); ?> <?php endif; ?>">Lihat Kos! ></a>
            </div>
            <div class="col-md-6">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Daffa's File SSD\WebDev\pweb-mid\resources\views/home.blade.php ENDPATH**/ ?>